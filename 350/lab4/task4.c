...
int main(void) {
	...
	if (rename("./hello", "/mnt/linuxlab/home/kjenifer1/Dir2/Dir21/hello") == -1) {
	...
	if (symlink("/mnt/linuxlab/home/kjenifer1/Dir2/Dir21", "/mnt/linuxlab/home/kjenifer1/Dir1/toDir21") == -1) {
		puts("*** Error creating the first symlink ***");
		return 5; // Returning because the first symlink could not be made
	}
	if (symlink("/mnt/linuxlab/home/kjenifer1/Dir2/Dir21/hello", "/mnt/linuxlab/home/kjenifer1/Dir1/toHello") == -1) {
